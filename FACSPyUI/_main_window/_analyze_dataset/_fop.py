...
class ConfigPanelFOP(BaseConfigPanel):
...
class PlotWindowFOP(PlotWindowFunctionGeneric):
    ...
    def generate_matplotlib(self, plot_config):
        ...
        try:
            ...
            self.show_error_dialog(f"Error generating Matplotlib plot with fp.pl.fop: {e}")
